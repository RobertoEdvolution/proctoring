...
$string['setting:audiochunkduration'] = 'Audio recording duration (seconds)';
$string['setting:audiochunkduration_desc'] = 'Duration in seconds of each audio recording chunk captured during a quiz attempt.';
$string['setting:audiocaptureinterval'] = 'Audio capture interval (seconds)';
$string['setting:audiocaptureinterval_desc'] = 'Interval in seconds between the start of each audio recording during a quiz attempt.';
...
$string['openwebcam'] = 'Exam monitoring notice';
...
$string['proctoringheader'] = '<strong>This quiz uses proctoring. Photos will be captured periodically during the exam using your webcam for identity verification purposes.</strong>';
$string['proctoringlabel'] = 'I understand that photos will be captured during this exam.';
...
$string['proctoringstatement'] = 'During this exam, photos will be captured periodically using your webcam for identity verification purposes.';
